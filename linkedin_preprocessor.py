...
try:
    ...
    for post in posts_data:
        cleaned_heading = preprocessor.clean_text(post.get("Post Caption/Heading", ""))
        cleaned_content = preprocessor.clean_text(post.get("Post Content", ""))
