...
json_path = os.path.join(os.path.dirname(__file__), "../../data/raw_data/facebook_raw_data.json")
image_base_path = os.path.join(os.path.dirname(__file__), "../../data/raw_data/facebook_raw_images")
